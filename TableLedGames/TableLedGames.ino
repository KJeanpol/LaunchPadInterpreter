...
void loop() {
  ...
  if (flagGame == 1) { //RECORDAR MODIFICAR flagGame en pruebas
    ...
    onTouchButton2(0, dato0);
    onTouchButton2(1, dato1);
    onTouchButton2(2, dato2);
    onTouchButton2(3, dato3);
    onTouchButton2(4, dato4);
    onTouchButton2(5, dato5);
  }
  else if (flagGame == 2) {
    goMaze();
//    int dato0 = analogRead(0);
...
//    int dato4 = analogRead(4);
//    int dato5 = analogRead(5);
//    onTouchButton(0, dato0, flagGame);
//    onTouchButton(1, dato1, flagGame);
//    onTouchButton(2, dato2, flagGame);
//    onTouchButton(3, dato3, flagGame);
//    onTouchButton(4, dato4, flagGame);
//    onTouchButton(5, dato5, flagGame);
  }
  else if (flagGame == 3) {
    scrollText();
      ...
      if (dato > 500 && dato < 520) {
        if (anPin == 0) {
          ...
          delay(250);
            ...
            Serial.println("b7");
            if (matriz[0][0] == 1 || matriz[1][1] == 1 || matriz[2][0] == 1 || matriz[0][1] == 1 || matriz[2][1] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b13");
            if (matriz[1][0] == 1 || matriz[1][1] == 1 || matriz[2][1] == 1 || matriz[3][1] == 1 || matriz[3][0] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b19");
            if (matriz[2][0] == 1 || matriz[4][0] == 1 || matriz[2][1] == 1 || matriz[3][1] == 1 || matriz[4][1] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b25");
            if (matriz[3][0] == 1 || matriz[5][0] == 1 || matriz[5][1] == 1 || matriz[3][1] == 1 || matriz[4][1] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b31");
            if (matriz[4][0] == 1 || matriz[5][1] == 1 ||  matriz[4][1] == 1) {
        ...
        if (anPin == 0) {
            Serial.println("b2");
            if (matriz[0][0] == 1 || matriz[0][2] == 1 || matriz[1][0] == 1 || matriz[1][1] == 1 || matriz[1][2] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b8");
            if ((matriz[0][0] == 1) || (matriz[1][2] == 1) || (matriz[0][2] == 1) || (matriz[2][0] == 1) || (matriz[2][2] == 1) || (matriz[0][1] == 1) || (matriz[2][1] == 1) || (matriz[1][0] == 1)) {
          ...
          delay(250);
            ...
            Serial.println("b14");
            if (matriz[1][0] == 1 || matriz[2][0] || matriz[1][1] == 1 || matriz[1][2] == 1 || matriz[3][2] == 1 || matriz[2][2] == 1 || matriz[3][1] == 1 || matriz[3][0] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b20");
            if (matriz[2][0] == 1 || matriz[4][0] == 1 || matriz[2][1] == 1 || matriz[3][2] == 1 || matriz[4][2] == 1 || matriz[3][0] == 1 || matriz[2][2] == 1 || matriz[4][1] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b26");
            if (matriz[4][0] = 1 || matriz[3][0] == 1 || matriz[5][0] == 1 || matriz[5][1] == 1 || matriz[3][1] == 1 || matriz[5][2] == 1 || matriz[3][2] == 1 || matriz[4][2] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b32");
            if (matriz[4][0] == 1 || matriz[5][0] == 1 ||  matriz[4][1] == 1 || matriz[4][2] == 1 || matriz[5][2] == 1) {
        ...
        if (anPin == 0) {
            Serial.println("b3");
            if (matriz[0][1] == 1 || matriz[0][3] == 1 || matriz[1][1] == 1 || matriz[1][3] == 1 || matriz[1][2] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b9");
            if (matriz[1][3] == 1 || matriz[0][1] == 1 || matriz[1][2] == 1 || matriz[0][2] == 1 || matriz[2][1] == 1 || matriz[2][2] == 1 || matriz[0][3] == 1 || matriz[2][3] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b15");
            if (matriz[2][3] == 1 || matriz[1][3] == 1 || matriz[1][1] == 1 || matriz[1][2] == 1 || matriz[3][2] == 1 || matriz[2][3] == 1 || matriz[3][1] == 1 || matriz[3][3] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b21");
            if (matriz[2][3] == 1 || matriz[4][3] == 1 || matriz[2][1] == 1 || matriz[3][3] == 1 || matriz[4][2] == 1 || matriz[3][2] == 1 || matriz[2][2] == 1 || matriz[4][1] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b27");
            if (matriz[4][3] == 1 || matriz[3][2] == 1 || matriz[5][3] == 1 || matriz[5][1] == 1 || matriz[3][1] == 1 || matriz[5][2] == 1 || matriz[3][3] == 1 || matriz[4][1] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b33");
            if (matriz[4][2] == 1 || matriz[5][1] == 1 ||  matriz[4][1] == 1 || matriz[4][3] == 1 || matriz[5][3] == 1) {
        ...
        if (anPin == 0) {
            Serial.println("b4");
            if (matriz[0][2] == 1 || matriz[0][4] == 1 || matriz[1][2] == 1 || matriz[1][3] == 1 || matriz[1][4] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b10");
            if (matriz[1][4] == 1 || matriz[0][2] == 1 || matriz[1][2] == 1 || matriz[0][4] == 1 || matriz[2][2] == 1 || matriz[2][4] == 1 || matriz[0][3] == 1 || matriz[2][3] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b16");
            if (matriz[2][4] == 1 || matriz[1][3] == 1 || matriz[1][4] == 1 || matriz[1][2] == 1 || matriz[3][2] == 1 || matriz[2][3] == 1 || matriz[3][3] == 1 || matriz[3][4] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b22");
            if (matriz[2][3] == 1 || matriz[4][3] == 1 || matriz[2][2] == 1 || matriz[3][4] == 1 || matriz[4][2] == 1 || matriz[3][2] == 1 || matriz[2][4] == 1 || matriz[4][4] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b28");
            if (matriz[4][4] == 1 || matriz[3][2] == 1 || matriz[5][3] == 1 || matriz[5][2] == 1 || matriz[3][3] == 1 || matriz[5][4] == 1 || matriz[3][4] == 1 || matriz[4][2] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b34");
            if (matriz[4][2] == 1 || matriz[5][2] == 1 ||  matriz[4][4] == 1 || matriz[4][3] == 1 || matriz[5][4] == 1) {
        ...
        if (anPin == 0) {
            Serial.println("b5");
            if (matriz[0][3] == 1 || matriz[0][5] == 1 || matriz[1][4] == 1 || matriz[1][3] == 1 || matriz[1][5] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b11");
            if (matriz[1][5] == 1 || matriz[0][4] == 1 || matriz[1][3] == 1 || matriz[0][5] == 1 || matriz[2][3] == 1 || matriz[2][4] == 1 || matriz[0][3] == 1 || matriz[2][5] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b17");
            if (matriz[2][5] == 1 || matriz[1][3] == 1 || matriz[1][4] == 1 || matriz[1][5] == 1 || matriz[3][5] == 1 || matriz[2][3] == 1 || matriz[3][3] == 1 || matriz[3][4] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b23");
            if (matriz[2][3] == 1 || matriz[4][3] == 1 || matriz[2][5] == 1 || matriz[3][3] == 1 || matriz[4][5] == 1 || matriz[3][5] == 1 || matriz[2][4] == 1 || matriz[4][4] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b29");
            if (matriz[4][3] == 1 || matriz[3][5] == 1 || matriz[5][3] == 1 || matriz[5][5] == 1 || matriz[3][3] == 1 || matriz[5][4] == 1 || matriz[3][4] == 1 || matriz[4][5] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b35");
            if (matriz[4][5] == 1 || matriz[5][3] == 1 ||  matriz[4][4] == 1 || matriz[4][3] == 1 || matriz[5][5] == 1) {
        ...
        if (anPin == 0) {
            Serial.println("b6");
            if (matriz[0][4] == 1 || matriz[1][4] == 1 || matriz[1][5] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b12");
            if (matriz[1][4] == 1 || matriz[0][4] == 1 || matriz[2][4] == 1 || matriz[0][5] == 1 || matriz[2][5] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b18");
            if (matriz[2][4] == 1  || matriz[1][4] == 1 || matriz[1][5] == 1 || matriz[3][5] == 1  || matriz[3][4] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b24");
            if (matriz[2][5] == 1 || matriz[3][4] == 1 || matriz[4][5] == 1 || matriz[2][4] == 1 || matriz[4][4] == 1) {
         ...
         delay(250);
            ...
            Serial.println("b30");
            if (matriz[4][4] == 1 || matriz[3][5] == 1  || matriz[5][5] == 1  || matriz[5][4] == 1 || matriz[3][4] == 1) {
          ...
          delay(250);
            ...
            Serial.println("b36");
            if (matriz[4][5] == 1 || matriz[5][4] == 1 ||  matriz[4][4] == 1) {
...
void onTouchButton2(int anPin, int dato) {
  if (dato > 100) {
    if (dato > 500 && dato < 520) {
      if (anPin == 0) {
