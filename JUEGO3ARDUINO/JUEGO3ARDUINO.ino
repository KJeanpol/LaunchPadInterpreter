...
void loop() {
  ...
  char yourText[type.length() + 1];
  strcpy(yourText, type.c_str());
  matrix.begin();
...
void matrit() {
  ...
  JsonObject& root = jsonBuffer.parseObject(json);
  String type = root["Text"];
  char yourText[json.length() + 1];
  strcpy(yourText, json.c_str());
  matrix.begin();
  matrix.setTextWrap(false);
  matrix.setBrightness(500);
  matrix.setTextColor(matrix.Color(80, 255, 0));
    ...
    if (dato > 100) {
      if (dato > 500 && dato < 520) {
        if (anPin == 0) {
          ...
          Serial.println("b7");
          Serial.println("nanda en 7");
          Serial.println(nanda[1][0]);
          if (nanda[1][0] == 1) {
          ...
          Serial.println("b13");
          Serial.print("______________nanda[2][0]");
          Serial.print(nanda[2][0]);
          if (nanda[2][0] == 1) {
        ...
        if (anPin == 0) {
          if (nanda[0][2] == 1) {
            pixels.setPixelColor(2, pixels.Color(2, 0, 255));
            pixels.show();
            matriz[0][2] = 0;
            expol();
          }
        ...
        if (anPin == 0) {
          ...
          Serial.println("b29");
          Serial.print("AQUI SE CAE");
          Serial.print(nanda[4][4]);
          if (nanda[4][4] == 1) {
          ...
          Serial.println("b35");
          Serial.print("error en b35");
          Serial.print(nanda[5][4]);
          if (nanda[5][4] == 1) {
